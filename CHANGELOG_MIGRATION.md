...
- TKT-012: Added offline mock legacy fixture replay worker with SSE support and no outbound HTTP.
- TKT-011: Added local Caddy routing-table generation, reload target, and verification tests.
